...
INSERT INTO User (username, password, email, isAdmin)
VALUES ('user2', '1234', 'tronghuychuyenlik24@gmail.com', 0);

INSERT INTO User (username, password, email, isAdmin)
VALUES ('user3', '1234', 'nchhdhn@gmail.com', 0);
...
INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (120000, 'Sugar Baby', 30, 1, 'Best of 2024 book', '2024-03-03', 1, 'book2.jpg', '20x24x8', '124312');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (80000, 'Ambition Monster', 50, 1.25, 'Best of 2024 Fiction book', '2024-08-11', 0, 'book3.jpg', '20x24x8', '4312');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (145000, 'The Fetishist', 18, 2, 'New one', '2024-10-02', 1, 'book4.jpg', '20x24x5', '122123');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (200000, 'Come & Get It', 60, 0.87, 'Best seller 2024', '2024-10-02', 0, 'book5.jpg', '24x24x5', '110023');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (233000, 'WORRY', 45, 1.22, 'Book seller of 2024', '2024-10-12', 1, 'book6.jpg', '20x24x8', '1221');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (175000, 'Blue Sisters', 40, 1.2, 'Book seller of 2024', '2024-10-10', 1, 'book7.jpg', '20x24x8', '12212');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (30000, 'Best of Blue', 25, 0.56, 'Blue Music CD', '2024-10-12', 1, 'cd1.jpg', '20x24x2', '12213');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (30000, 'The Dreaming', 30, 0.66, 'Fall in dreaming space', '2024-10-12', 1, 'cd2.png', '20x24x2', '12214');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (130000, 'The Fame Monster', 35, 0.6, 'Fall in Lady Gaga new release', '2024-10-12', 1, 'cd3.jpg', '20x24x2', '12215');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (140000, 'The Pink Print', 30, 0.6, 'Nicki Minaj New Album', '2024-10-12', 1, 'cd4.jpg', '20x24x2', '12216');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (140000, 'The Album', 32, 0.6, 'The First Full Album of BlackPink', '2024-10-10', 0, 'cd5.jpg', '20x24x2', '12218');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (70000, 'Square One: Boombayah', 35, 0.66, 'New Single of BlackPink', '2024-10-10', 0, 'cd6.jpg', '20x24x2', '122123');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (120000, 'Ferrari', 40, 0.66, 'FERRARI NEWEST FILM', '2024-10-10', 1, 'dvd1.jpg', '20x24x2', '82123');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (220000, 'BeeKeeper', 49, 0.66, 'Hottest block', '2024-10-09', 1, 'dvd2.jpg', '20x24x2', '8223');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (210000, 'The Image Of You', 55, 0.66, 'Hottest block', '2024-10-09', 1, 'dvd3.jpg', '20x24x2', '82232');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (240000, 'Killers of Flower Moon', 90, 0.56, 'Hottest film in 2024', '2024-09-09', 1, 'dvd4.jpg', '20x24x2', '82234');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (160000, 'Perfect Days', 87, 0.56, 'Healing film', '2024-09-09', 1, 'dvd5.jpg', '20x24x2', '82237');

INSERT INTO Media (price, title, totalQuantity, weight, description, importDate, rushOrderSupported, imageUrl, productDimension, barcode)
VALUES (1850000, 'A Regular Woman', 94, 0.6, 'Best of 2022', '2024-09-09', 1, 'dvd6.jpg', '20x24x2', '8223477');
